export const PYTHON_APP_PY_CODE = `"""
...
with st.sidebar:
    ...
    api_key_input = st.text_input(
        ...
        value=default_key,
        type="password",
        help="Get a free API key from Google AI Studio at https://aistudio.google.com/",
        placeholder="AIzaSy..."
    )
    ...
    st.divider()
    st.caption("Architecture: 100% free-tier compatible using Google Gemini 1.5 Flash + Streamlit HTML Components.")
...
st.markdown(
    ...
    "powered by **Google Gemini 1.5 Flash**. The generated animation is rendered live below."
)
...
if generate_clicked:
    ...
    # 2. Validation: Check if user prompt is provided
        ...
        with st.spinner("✨ Gemini is writing HTML5 Canvas code for your animation..."):
            try:
...
if st.session_state.generated_html:
    ...
    with st.expander("🔍 View Generated HTML/JavaScript Source Code", expanded=False):
        st.markdown(
            "Below is the complete, single-file HTML5 Canvas document produced by Google Gemini:"
        )
